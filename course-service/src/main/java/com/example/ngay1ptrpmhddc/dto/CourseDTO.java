package com.example.ngay1ptrpmhddc.dto;
...
public class CourseDTO {
    ...
    @Min(value = 1, message = "So tin chi phai lon hon hoac bang 1")
    private Integer soTinChi;

    @NotNull(message = "So cho toi da khong duoc de trong")
    @Min(value = 1, message = "So cho toi da phai lon hon hoac bang 1")
